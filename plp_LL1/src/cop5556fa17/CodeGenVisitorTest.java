...
public class CodeGenVisitorTest implements ImageResources{
	...
	public void image7() throws Exception {
		String prog = "image7"; //args: <inputImageURL> <outputImageURL>
		String input = prog + " \n"
				+"image[1024,1024] h;\n"
				+"image[1024,1024] g;\n"
				+"g <- @ 0;\n"
	...
	@Test
	public void imageFunctionIndexArg() throws Exception{
		devel = false;
		grade = true;
		String prog = "progimageFunc";
		String input = prog +
				"\n image g; \r\n" + 
				"g[[r,a]] = cart_x[r,a]; \r\n" + 
				"g -> SCREEN;";
	...
	public void abc() throws Exception{
		devel = false;
		grade = true;
		String prog = "imageIO2";//args: <imageURL>\n 
		String input = prog 
		+ " image g; \n"
		+ "file f = \"newImage.jpg\"; \n"
		+ "g <- @ 0;\n"
