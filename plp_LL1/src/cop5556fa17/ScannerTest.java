...
public class ScannerTest {
	 ...
	 */
	@Test
	public void stringLiteral() throws LexicalException {
	...
	@Test
	public void not_escapesequence() throws LexicalException {
	...
	@Test
	public void integerOutOfRange() throws LexicalException {
		String input = "0999999999999999999999999999";
		show(input);
		thrown.expect(LexicalException.class);  //Tell JUnit to expect a LexicalException
		try {
			new Scanner(input).scan();
	...
	@Test
	public void identifier_op_keyword() throws LexicalException {
		String input = "def+a";
		Scanner scanner = new Scanner(input).scan();
		show(input);
		show(scanner);
		...
		checkNext(scanner, KW_a, 4, 1, 1, 5);	
		checkNextIsEOF(scanner);
	}
	@Test
	public void eof() throws LexicalException{
		final char EOFchar = 0;
		String s =  "abc"+EOFchar+"def";
		Scanner scanner = new Scanner(s).scan();
		show(s);
		show(scanner);
		checkNext(scanner, IDENTIFIER, 0, 3, 1, 1);
		checkNextIsEOF(scanner);
	...
	@Test
	public void tab() throws LexicalException{
		final char EOFchar = 0;
		String s = "\"\t\\\"ABC\"";
		Scanner scanner = new Scanner(s).scan();
		show(s);
	...
	@Test
	public void big() throws LexicalException{
		String s = "\r\n" + 
				"\r\n" + 
				"// this is a simple program \r\n" + 
				" a = 123 ; b = 345;\r\n" + 
				"a a ; int _hyt56$ ; \r\n" + 
				"string = \"oye oye	simran ## \\n najane tu chali hai kahaan..... \\n \\\\\\t\\r\\\"\\'\";\r\n" + 
				"\r\n" + 
				";;\r\n" + 
				"\r\n" + 
				"boolean a = a / 2 + (3);\r\n" + 
				"int // %^&*(@#$%^&*()\r\n" + 
				"; is true == false ? not\r\n" + 
				"image i = 0123 + 000; url = \"http://www.r40rjoiv923834246^^*(^*.com\";\r\n" + 
				"\r\n" + 
				"\r\n" + 
				"";
		Scanner scanner = new Scanner(s).scan();
